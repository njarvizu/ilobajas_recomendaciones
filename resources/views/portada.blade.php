...
<header>
    <div class="container">
        <div class="intro-text">
            ...
            <div class="intro-heading">iLoBajas</div>
            <a href="#services" class="page-scroll btn btn-xl">Ir a peliculas</a>
        </div>
    </div>
</header>
          ...
          <div class="col-md-1 col-sm-5 portfolio-item">
            ...
            <div class="col-md-3 col-sm-5 portfolio-item">
                <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                    ...
                    <img src="img/portfolio/golden.png" class="img-responsive img-centered" alt="">
                </a>
            ...
            <div class="col-md-3 col-sm-6 portfolio-item">
                <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                    ...
                    <img src="img/portfolio/startup-framework.png" class="img-responsive img-centered" alt="">
                </a>
                <div class="portfolio-caption">
            ...
            <div class="col-md-3 col-sm-6 portfolio-item">
                <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal">
                    ...
                    <img src="img/portfolio/treehouse.png" class="img-responsive img-centered" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Treehouse</h4>
                    <p class="text-muted">Website Design</p>
